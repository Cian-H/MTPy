...
class Sha1(object):
        ...
        if j is None:
            return [
                self._tab.Get(
                    ...
                    self._tab.Pos + flatbuffers.number_types.UOffsetTFlags.py_type(0 + i * 1),
                )
                for i in range(self.BytearrayLength())
            ]
        elif j >= 0 and j < self.BytearrayLength():
            return self._tab.Get(
                flatbuffers.number_types.Uint8Flags,
                self._tab.Pos + flatbuffers.number_types.UOffsetTFlags.py_type(0 + j * 1),
            )
        else:
            return None
    ...
    def BytearrayAsNumpy(self):
        return self._tab.GetArrayAsNumpy(
            flatbuffers.number_types.Uint8Flags, self._tab.Pos + 0, self.BytearrayLength()
        )
