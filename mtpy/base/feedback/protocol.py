...
class LoggerProtocol(Protocol):
    """A protocol defining logger objects accepted by MTPy classes.

    This protocol allows any logger to be used as long as it conforms to
    ...
    def debug(self: "LoggerProtocol", message: str, *args, **kwargs) -> None:
        ...
        Args:
            self (LoggerProtocol): The logger object instance
...
class ProgressBarProtocol(Protocol, Generic[T_co]):
    ...
    conforms to tqdm's basic method of decorating iterators.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            self (ProgressBarProtocol): The progressbar instance being initialised
            iterable (Iterable[T_co]): Iterable to decorate with a progressbar.
