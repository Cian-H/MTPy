...
class DummyLogger:
    ...
    def debug(self: "DummyLogger", message: str, *args, **kwargs) -> None:
        ...
        Args:
            self (DummyLogger): The logger object instance
...
class DummyProgressBar(Generic[T_co]):
    """A dummy object placeholding for progress bar objects accepted by MTPy classes."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            self (DummyProgressBar): The progressbar instance being initialised
